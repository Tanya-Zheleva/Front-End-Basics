...
describe('Event', function () {
  ...
  if (!this.isTouchDevice) {
    ['click', 'dblclick', 'mousedown', 'mouseup', 'mouseover', 'mouseout', 'mousemove', 'mouseenter', 'mouseleave'].forEach(function (event) {
      describe(event + '()', function () {
  ...
  describe('on()', function () {
    ...
    it('attaches a handler to a namespaced event', function () {
      ...
      rect3.on('event.namespace3', function () {
        butter = 'melting';
      });
      rect3.on('event', action);
  ...
  describe('off()', function () {
    ...
    it('detaches a specific namespaced event listener, all other still working', function () {
      ...
      rect3.on('event.namespace', function () {
        butter = 'melting';
      });
    ...
    it('detaches all listeners for a specific namespace', function () {
      rect.on('event', action);
      rect.on('event.namespace', function () {
        butter = 'melting';
      });
      rect.off('.namespace');
