...
describe('Element', function () {
  ...
  describe('attr()', function () {
    ...
    afterEach(function () {
      rect.remove();
      draw.defs().select('pattern').each(function () {
        this.remove();
      });
    });
  ...
  describe('svg()', function () {
    describe('without an argument', function () {
      ...
      it('returns partial raw svg when called on a sub group', function () {
        ...
        expect(toBeTested === '<g><rect width="100" height="100"></rect><circle r="50" cx="50" cy="50" fill="#ff0066"></circle></g>' || toBeTested === '<g><rect height="100" width="100"></rect><circle fill="#ff0066" cy="50" cx="50" r="50"></circle></g>' || toBeTested === '<g xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100"></rect><circle r="50" cx="50" cy="50" fill="#ff0066"></circle></g>').toBeTruthy();
      });
      it('returns a single element when called on an element', function () {
        ...
        expect(toBeTested === '<circle r="50" cx="50" cy="50" fill="#ff0066"></circle>' || toBeTested === '<circle fill="#ff0066" cy="50" cx="50" r="50"></circle>' || toBeTested === '<circle xmlns="http://www.w3.org/2000/svg" r="50" cx="50" cy="50" fill="#ff0066"></circle>').toBeTruthy();
      });
    });
    describe('with raw svg given', function () {
      ...
      it('does not import on single elements, even with an argument it acts as a getter', function () {
        ...
        expect(result === '<rect width="100" height="100"></rect>' || result === '<rect height="100" width="100"></rect>' || result === '<rect xmlns="http://www.w3.org/2000/svg" width="100" height="100"></rect>').toBeTruthy();
      });
    });
  });
