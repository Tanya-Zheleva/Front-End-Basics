...
SVG.extend(SVG.FX, {
  ...
  , x: function x(_x, relative) {
    if (this.target() instanceof SVG.G) {
      this.transform({ x: _x }, relative);
      return this;
    }

    var num = new SVG.Number(_x);
  ...
  , width: function width(_width) {
    return this.add('width', new SVG.Number(_width));
  }
  // Add animatable height
  , height: function height(_height) {
    return this.add('height', new SVG.Number(_height));
  }
  // Add animatable plot
